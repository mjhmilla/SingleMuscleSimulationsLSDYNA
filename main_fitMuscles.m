...
vexatQuadraticCurves = tmp.felineSoleusNormMuscleQuadraticCurves;
...
if(flag_checkBezierCurveInterpolation==1)
    ...
    for i=1:1:length(curveFields)
        errMatrix= curveC.(curveFields{i}) ...
            - vexatQuadraticCurves.forceLengthDistalTitinCurve.(curveFields{i});
...
[modelParams.umat43Upd,vexatCurves] = ...
    fitVEXATTendon(...
        ...
        ktNIso,...
        vexatQuadraticCurves.tendonForceLengthNormCurve,...
        vexatCurves);
...
%             modelParams.umat43Upd,...
%             vexatQuadraticCurves.activeForceLengthCurve,...
%             vexatQuadraticCurves.tendonForceLengthInverseNormCurve,...
...
[modelParams.umat43Upd, keyPointsVEXATFpe,vexatCurves]= ...
    fitVEXATPassiveForceLengthRelation(...
        ...
        modelParams.umat43Upd,...
        keyPointsHL1997, keyPointsHL2002,...
        vexatQuadraticCurves.fiberForceLengthCurve,...
        vexatQuadraticCurves.fiberForceLengthInverseCurve,...
        vexatCurves,...
...
lceNLb1A = vexatQuadraticCurves.fiberForceLengthCurve.xEnd(1,1)...
    +umat43.shiftPEE;

modelParams.umat43Upd.lceHNLb1A = lceNLb1A*0.5;


vexatCurves=...
    calcVEXATTitinForceLengthRelationV2(...
        modelParams.umat43Upd,...
        defaultFelineSoleus.sarcomere,...
        vexatQuadraticCurves,...
        zeroFelineTitinQuadraticCurves,...
...
[modelParams.umat43Upd, vexatCurves, keyPointsVEXATFv]= ...
    fitVEXATForceVelocityRelation(...
        modelParams.umat43Upd,...
        keyPointsHL1997,...
        vexatQuadraticCurves.fiberForceVelocityCurve,...
        vexatCurves,...
