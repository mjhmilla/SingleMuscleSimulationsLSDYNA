...
if(flag_checkBezierCurveInterpolation==1)
    ...
    for i=1:1:length(curveFields)
        errMatrix= curveC.(curveFields{i}) ...
            - felineSoleusNormMuscleQuadraticCurves.forceLengthDistalTitinCurve.(curveFields{i});
...
lceNLb1A = felineSoleusNormMuscleQuadraticCurves.fiberForceLengthCurve.xEnd(1,1)...
    +umat43.shiftPEE;
