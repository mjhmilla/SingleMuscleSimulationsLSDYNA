...
kTitinOneHalf = kpeOneHalf;
if(flag_embedECMandTitinFractionIntoCurves==1)
...
yigdZero    = kigd*(forceLengthCurveSettings.yZero ...
                    /forceLengthCurveSettings.kToe);                    
...
ligpZeroHalf     = ligpOneHalf      - ((1-scaleECM)/kigp) ...
                 - ((1-scaleECM)/kigp)*lowStrainWidth; 
lpevkZeroHalf    = lpevkOneHalf  - ((1-scaleECM)/kpevk) ...
                  - ((1-scaleECM)/kpevk)*lowStrainWidth;  
ligdZeroHalf     = ligdOneHalf      - ((1-scaleECM)/kigd) ...
                 - ((1-scaleECM)/kigd)*lowStrainWidth; 


lPZeroHalf      = lPOneHalf      - ((1-scaleECM)/kP) ...
                 - ((1-scaleECM)/kP)*lowStrainWidth; 
lDZeroHalf      = lDOneHalf  - ((1-scaleECM)/kD) ...
                 - ((1-scaleECM)/kD)*lowStrainWidth;  
%%
