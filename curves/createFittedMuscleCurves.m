...
smallNumericallyNonZeroValue=smallNumericallyNonZeroNumber;
...
flag_sharpEccentricTransition = 1;
...
forceLengthCurveSettings = struct('normLengthZero',0,'normLengthToe',0,'fToe',0,...
                                  'yZero',0,'kZero',0,'kToe',0,'curviness',0);
...
if(isempty(dataPassiveForceLength) == 0)
  ...
  fixedParams = [kLow,kNum,kZero,yZero,curviness];
  ...
  forceLengthCurveSettings.yZero          = yZero;
  ...
  if(isempty(passiveForceLengthCurveSettings)==0)

    normLengthZero  = passiveForceLengthCurveSettings.normLengthZero;
    normLengthToe   = passiveForceLengthCurveSettings.normLengthToe;
    fToe            = passiveForceLengthCurveSettings.fToe;
    yZero           = passiveForceLengthCurveSettings.yZero;    
    kZero           = passiveForceLengthCurveSettings.kZero;
    kToe            = passiveForceLengthCurveSettings.kToe;
    kLow            = passiveForceLengthCurveSettings.kLow;
    curviness       = passiveForceLengthCurveSettings.curviness;
...
scaleECM = sarcomereProperties.extraCellularMatrixPassiveForceFraction;  

if(flag_embedECMandTitinFractionIntoCurves == 0)
    scaleECM=1;
end
...
normMuscleCurves.forceLengthECMHalfCurve  = ...
  createFiberForceLengthCurve2021((forceLengthCurveSettings.normLengthZero)*0.5,...
                              ...
                              scaleECM,...
                              forceLengthCurveSettings.yZero*(scaleECM*2),...
                              forceLengthCurveSettings.kZero*(scaleECM*2),...
                              forceLengthCurveSettings.kLow*(scaleECM*2),...
                              forceLengthCurveSettings.kToe*(scaleECM*2),...
...
normMuscleCurves.tendonForceLengthNormCurve = ...
  createTendonForceLengthCurve2021( eZero, eIso, kIso, ...
                                    fToe, curvinessTendon, ...
                                    computeIntegral, ...
                                    flag_enableNumericallyNonZeroGradients,...
...
fprintf('  tendonForceLengthNormCurve created\n');
  
normMuscleCurves.tendonForceLengthInverseNormCurve = ...
  createInverseCurve(normMuscleCurves.tendonForceLengthNormCurve);

fprintf('  tendonForceLengthInverseNormCurve created\n');  


computeIntegral = 0;
normMuscleCurves.tendonStiffnessNormCurve = ...
          createTendonStiffnessCurve2021( normMuscleCurves.tendonForceLengthNormCurve,...
                                        curvinessTendon*curvinessTendon,...
                                        musculotendonProperties.name,...
                                        flag_useOctave);
