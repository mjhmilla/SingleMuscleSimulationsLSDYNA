...
simulationTypeList  = {'quickrelease'};%,'concentric','isometric','quickrelease'};
...
numberOfVerticalPlotRowsGeneric      = 8;
plotWidth         = 6;
plotHeight        = 6;        
...
musoutColorA = [1,0,0].*(0.9)+[1,1,1].*(0.1);
musoutColorB = [1,0,0].*(0.5)+[1,1,1].*(0.5);
  ...
  for indexRelease = 1:length(Releases)
      ...
      for indexSimulationType = 1:length(simulationTypeList)
          ...
          if(flag_figGenericDirty==1)
              ...
              fileName = ['fig_',Release,'_',simulationTypeList{indexSimulationType},'_Generic.pdf'];
