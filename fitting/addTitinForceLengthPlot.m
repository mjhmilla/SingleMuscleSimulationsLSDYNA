...
figure(figH);
    ...
    plot(vexatCurves.f2.active.lceNAT,...
        vexatCurves.fecm.fceNAT+vexatCurves.f2.active.fceNAT,...
        plotSettings.umat43.lineType,...
        'Color',[1,1,1],...
        'HandleVisibility','off',...                      
        'LineWidth',umat43LineWidth);
...
%     hold on;
    ...
    x1 = max(vexatCurves.fecm.lceNAT);
    y1 = max(vexatCurves.fecm.fceNAT);
    x2 = x1;
    y2 = y1 + max(vexatCurves.f2.fceNAT);
    ...
    lceNATTwo = interp1(...
        vexatCurves.fecm.fceNAT+vexatCurves.f2.active.fceNAT,...
        vexatCurves.f2.active.lceNAT,...
        1);

    th = text(lceNATTwo+2*dx,1,...
    ...
    xlim([min(vexatCurves.fecm.lceNAT),max(vexatCurves.fecm.lceNAT)]);
    ...
    title(['E. Titin fitting $$\mathbf{f}^\mathrm{ECM},\,',...
           '\mathbf{f}^\mathrm{1},\,\mathbf{f}^\mathrm{2}$$']);

    [lgdH, lgdIcons, lgdPlots, lgdTxt]=...
        legend('Location','north','FontSize',6);
