...
figure(figH);
    ...
    idxMin = find(vexatCurves.fpe.fceNAT > 0.1,1,'first');

    lceNATMax = interp1(vexatCurves.fpe.fceNAT(idxMin:end,1),...
                        vexatCurves.fpe.lceNAT(idxMin:end,1),...
                        max(plotSettings.ylim));

    fpeXlim = [(lcePeZero-0.05),lceNATMax];
    xlim(fpeXlim);
