...
lceNATOne = interp1(ehtmmCurves.fpe.fceNAT(50:end),...
                    ehtmmCurves.fpe.lceNAT(50:end),1);
fceNATOne  = interp1(ehtmmCurves.fpe.lceNAT(50:end),...
                    ehtmmCurves.fpe.fceNAT(50:end),lceNATOne);
kceNATOne  = interp1(ehtmmCurves.fpe.lceNAT(50:end),...
                    ehtmmCurves.fpe.kceNAT(50:end),lceNATOne);
...
figure(figH);
    ...
    text(keyPointsVEXATFpe.lceNAT-0.05,...
         keyPointsVEXATFpe.fceNAT,...
         sprintf('%s%1.2f%s',...
         '$$k^{PE}_o=$$',...
    ...
    text(keyPointsVEXATFpe.lceNAT-0.05,...
         keyPointsVEXATFpe.fceNAT-0.075,...
         sprintf('%s%1.2f%s',...
         '$$k^{PE}_o=$$',...
         kceNATOne,...
         '$$f^M_o/\ell^M_o$$'),...
