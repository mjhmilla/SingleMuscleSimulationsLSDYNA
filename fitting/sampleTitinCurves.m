...
if(flag_usingQuadraticCurves==0)
    ...
    curveSampleECMHalf  = struct('x',z0,'y',z0,'dydx',z0);
    
    curveSampleProximal     = struct('x',z0,'y',z0,'dydx',z0);
    curveSampleDistal       = struct('x',z0,'y',z0,'dydx',z0);
    
    curveSampleIgp  = struct('x',z0,'y',z0,'dydx',z0);
    curveSamplePevk = struct('x',z0,'y',z0,'dydx',z0);
    curveSampleIgd  = struct('x',z0,'y',z0,'dydx',z0);
    
    curveSampleTitin        = struct('x',z0,'y',z0,'dydx',z0);
    curveSampleTitinActive  = struct('x',z0,'y',z0,'dydx',z0); 
end
