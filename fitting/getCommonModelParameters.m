...
if(flag_assertCommonParamsIdentical==1)
    ...
    assert( abs(umat43.vceMax    -umat41.vceMax   )<tol,...
        'Error: umat41 and umat43 differ at vceMax'   ); 
    assert( abs(umat43.dtInt     -umat41.dtInt    )<tol,...
        'Error: umat41 and umat43 differ at dtInt '   ); 
...
if(flag_assertCommonParamsIdentical==1)
    ...
    assert( abs(mat156.vceMax    -umat43.vceMax   )<tol,...
        'Error: mat156 and umat43 differ at vceMax'   ); 
    assert( abs(mat156.dtInt     -umat43.dtInt    )<tol,...
        'Error: mat156 and umat43 differ at dtInt '   ); 
