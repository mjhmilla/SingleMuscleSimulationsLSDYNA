function [figH]= addFittedActiveForceLengthPlotV2(figH,umat41,umat43,...
...
umat41FalError = calcEHTMMActiveCurveErrorV2([1;1;1;1],umat41,...
                    keyPointsHL1997, keyPointsHL2002);

umat41FalRMSE = sqrt(mean(umat41FalError.^2));

defaultSoln.lceOptAT = keyPointsHL1997.lceOptAT;
defaultSoln.fceOptAT = keyPointsHL1997.fceOptAT;
umat43Soln = [1;1;keyPointsHL1997.lceNATZero];
keyPointsScaling.length=0.001;
keyPointsScaling.force = 1;

umat43FalHL1997Error = ...
    calcVEXATActiveForceLengthError(umat43Soln,....
                    defaultSoln,...
                    umat43,...
                    keyPointsHL1997,...
                    keyPointsScaling,...
...
defaultSoln.lceOptAT = keyPointsHL2002.lceOptAT;
defaultSoln.fceOptAT = keyPointsHL2002.fceOptAT;
umat43Soln = [1;1;keyPointsHL2002.lceNATZero];

umat43FalHL2002Error = ...
    calcVEXATActiveForceLengthError(umat43Soln,....
                    defaultSoln,...
                    umat43,...
                    keyPointsHL2002,...
...
umat43FalError = [umat43FalHL1997Error;umat43FalHL2002Error];
umat43FalRMSE = sqrt(mean(umat43FalError.^2));
