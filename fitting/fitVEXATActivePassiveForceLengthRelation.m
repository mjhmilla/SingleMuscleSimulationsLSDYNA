...
lceNMin = umat43QuadraticCuves.activeForceLengthCurve.xEnd(1,1)-0.1;
lceNMax = umat43QuadraticCuves.activeForceLengthCurve.xEnd(1,2)+0.1;
...
for i=1:1:npts
    ...
    flN = calcQuadraticBezierYFcnXDerivative(lceN(i,1),...
            umat43QuadraticCuves.activeForceLengthCurve,0);
