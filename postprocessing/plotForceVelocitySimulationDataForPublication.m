...
if(flag_addSimulationData==1)  
    ...
    elseif(contains(simulationDirectoryName,simMetaData.fileNameMaxActEnd))
    ...
    elseif(contains(simulationDirectoryName,simMetaData.fileNameSubMaxActStart))
        fid=fopen([simulationFolder,filesep,'record.csv'],'w');
        fprintf(fid,'%1.3e,%1.3e,%1.3e,%1.3e,%1.3e\n',...
                    simFvSample(1,1),...
                    simFvSample(1,2),...
    ...
    elseif(contains(simulationDirectoryName,simMetaData.fileNameSubMaxActEnd))
        fid=fopen([simulationFolder,filesep,'record.csv'],'a');
        fprintf(fid,'%1.3e,%1.3e,%1.3e,%1.3e,%1.3e\n',...
                    simFvSample(1,1),...
                    simFvSample(1,2),...
