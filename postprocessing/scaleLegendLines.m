...
if(found==1)
    ...
    xDataUpd = [xDataOrig(1)+lineLength*scale, xDataOrig(2)];
    ...
    for idxIcon = 1:1:length(lgdIcons)
        ...
        if(contains(objClass,'matlab.graphics.primitive.Patch')==1)  
            ...
            vertices(1,1)= vertices(1,1)+ scale*(vertices(3,1)-vertices(1,1));
            vertices(2,1)= vertices(2,1)+ scale*(vertices(4,1)-vertices(2,1));
