...
%                 end
                ...
                mat156FalData = getCurveValueFromLSDYNAInputFile(...
                    fullfile(commonParameterFolder,'catsoleusHL2002Mat156.k'),...
                    idFalMat156);

                mat156FpeData = getCurveValueFromLSDYNAInputFile(...
                    fullfile(commonParameterFolder,'catsoleusHL2002Mat156.k'),...
                    idFpeMat156);

                xEnd = mat156FpeData(end,1) ...
                    + max(mat156FpeData(:,1))-min(mat156FpeData(:,1));
                yEnd = interp1(mat156FpeData(:,1),mat156FpeData(:,2),xEnd,...
                       'linear','extrap');
                ...
                if(flag_useUmat43Reference==1)
                    fpeRefData = umat43FpeData;
                    falRefData = umat43FlData;
                else
                    fpeRefData = mat156FpeData;
                    falRefData = mat156FlData;                    
                end

                fill([0;falRefData(:,1);falRefData(end,1);falRefData(1,1)],...
                     [0;falRefData(:,2);0;0],...
                     [1,1,1].*0.65,...
                     'EdgeColor','none',...
                ...
                fill([fpeRefData(:,1);fpeRefData(end,1);fpeRefData(1,1)],...
                     [fpeRefData(:,2);fpeRefData(1,2);fpeRefData(1,2)],...
                     [1,1,1].*0.55,...
                     'EdgeColor','none',...
                     'HandleVisibility','off');
                hold on;
    
                plot(falFpeData(:,1),falFpeData(:,2),'Color',[1,1,1].*0.75,...
