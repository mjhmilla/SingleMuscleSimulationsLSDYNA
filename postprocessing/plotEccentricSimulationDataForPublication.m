...
%                 end
                ...
                falFpeUmat43=zeros(size(umat43FlData,1),2);
                for i=1:1:size(umat43FlData,1)
                    falFpeUmat43(i,1)=umat43FlData(i,1);
                    fpe = interp1(umat43FpeData(:,1),...
                                  umat43FpeData(:,2),falFpeUmat43(i,1),...
                                  'linear','extrap');
                    falFpeUmat43(i,2)=fpe+umat43FlData(i,2);
                end

                %falFpeUmat43 = umat43FlData(:,2)+umat43FpeData(:,2);

                fill([umat43FpeData(:,1);umat43FpeData(end,1);umat43FpeData(1,1)],...
                     [umat43FpeData(:,2);umat43FpeData(1,2);umat43FpeData(1,2)],...
                     [1,1,1].*0.55,...
                     'EdgeColor','none',...
                     'HandleVisibility','off');
                hold on;
    
                plot(falFpeUmat43(:,1),falFpeUmat43(:,2),'Color',[1,1,1].*0.75,...
